    ...
    <!-- Page Body here...Editable region -->
        ...
        <div class="warper container-fluid">
          ...
          <div class="page-header">
            <h1>Check - In Guest <small style="color:#FF404B">( Routine )</small></h1>
              <h1>
                <small><a href="<?php echo $baseUri; ?>/guest/checkInOptions">Check In Options</a></small>
                <small> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; </small>
                <small><a href="<?php echo $baseUri; ?>/guest/checkIn">Routine Check In</a></small>
              </h1>
          </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/guest/checkIn">

                            <div class="form-group">
                                  <label for="" class="col-sm-3 control-label"><span style="margin-top:10px">Guest Phone No.</span></label>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                          <input type="text" name="phone" placeholder="Enter Guest Phone No. & search for Guest" class="form-control form-control-circle" id="phone" autocomplete="off" value="<?php echo $session->read('phone') ? $session->read('phone') : ''; $session->write('phone', null); ?>" required>
                                          <span class="input-group-btn">
                                            <button class="btn btn-info btn-circle" id="searchGuestBtn" type="button">Search</button>
                                          </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="name" id="name" class="form-control form-control-circle" value="<?php echo $session->read('name') ? $session->read('name') : ''; $session->write('name', null); ?>" autocomplete="off" required>
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Address</label>
                                <div class="col-sm-9">
                                  <input type="text" name="addr" id="addr" class="form-control form-control-circle" value="<?php echo $session->read('addr') ? $session->read('addr') : ''; $session->write('addr', null); ?>" autocomplete="off" required>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="occu" id="occu" class="form-control form-control-circle" id="inputPassword3" value="<?php echo $session->read('occu') ? $session->read('occu') : ''; $session->write('occu', null); ?>" autocomplete="off" required>
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Reason for Visit</label>
                                <div class="col-sm-9">
                                  <input type="text" name="reason" id="reason" class="form-control form-control-circle"  value="<?php echo $session->read('reason') ? $session->read('reason') : ''; $session->write('reason', null); ?>" required>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                      <select class="form-control chosen-select form-control-circle" data-placeholder="" name="noOfOccupants" required>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                      ...
                                      <select class="form-control chosen-select" name="roomType" id="roomTypes" onChange="getRoomsByType(this.value)" required>
                                          <option></option>
                                          <?php
                              ...
                              <div class="form-group">
                                    ...
                                    <!-- <input type="text" name="discount" id="discount" class="form-control form-control-circle" onkeyUp="subtractDiscount2(this.value, 'discount')" > -->
                              ...
                              <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                  <button type="submit" name="submit" class="btn btn-success btn-circle">Check In</button>
                                </div>
                              </div>
                            </form>
