    ...
    <!-- Page Body here...Editable region -->
        ...
        <div class="warper container-fluid">
          ...
          <div class="page-header">
            <h1>Guest Late Check Out <small style="color:#FF404B">( <?php echo dateToString(today()); ?> )</small></h1>
            <h1>
                <small><a href="<?php echo $baseUri; ?>/guest/manage">Manage Guest</a></small>
                <small> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; </small>
                <small><a href="<?php echo $baseUri; ?>/guest/lateCheckOut">Late Check Out</a></small>
              </h1>
                  ...
                  <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/guest/lateCheckOut">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-3 control-label">Check Out Time</label>
                                    <div class="col-sm-5">
                                        <select class="form-control chosen-select form-control-circle"  name="time" required  >
                                          <option value="1pm"> 1pm </option>
                                          <option value="2pm"> 2pm </option>
                                          <option value="3pm"> 3pm </option>
                                          <option value="4pm" selected="selected"> 4pm </option>
