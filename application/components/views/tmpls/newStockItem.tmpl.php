...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Add New Stock Item <small>&nbsp;</small></h1>
              <h1>
                <small><a href="<?php echo $baseUri; ?>/item/addNewOptions">New Item Options</a></small>
                <small> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; </small>
                <small><a href="<?php echo $baseUri; ?>/item/newStockItem">New Stock Item</a></small>
              </h1>
                ...
                <div class="col-md-8">
                  ...
                  ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/item/newStockItem">
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                      <select class="form-control chosen-select" data-placeholder="" name="unit" required>
                                          <option></option>
                                          <?php
