...
#check if user has access to this page ( super admin | POS units )
$registry->get('authenticator')->checkPrivilege($thisUser->get('activeAcct'), array(1,8,9,10,11,12,13,15), true);
...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Remove Item From Stock <small>&nbsp;</small></h1></div>
                   ...
                   <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/stock/removeItem">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" name="reason" id="reason" class="form-control inputmask form-control-circle"  autocomplete="off" required> 
                                </div>
                              </div>
