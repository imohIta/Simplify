...
?>
    ...
    <!-- Page Body here...Editable region -->
        ...
        <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Manage Bad Rooms <small></small></h1></div>
            
            <div class="row">
                
                <a href="<?php echo $baseUri; ?>/reception/viewBadRooms">
                <div class="col-md-6 col-lg-3">
                    <div class="panel panel-default clearfix dashboard-stats rounded btn-gry">
                        ...
                        <h3 class="transit2">View All</h3>
                    </div>
                </div>
                </a>

                <a href="<?php echo $baseUri; ?>/reception/addBadRoom">
