...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Add New Impress Category <small>&nbsp;</small></h1></div>
                   ...
                   <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/impress/addNewCategory">
                                
                            <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Category Name</label>
                                    <div class="col-sm-9">
                                     <input type="text" name="catName" class="form-control form-control-circle" autocomplete="off" required>
