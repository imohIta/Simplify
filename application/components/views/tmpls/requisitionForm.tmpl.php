...
$registry->get('authenticator')->checkPrivilege($thisUser->get('activeAcct'), array(1,8,9,10,11,12,15), true);
...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Requisite For Item <small>&nbsp;</small></h1></div>
                   ...
                   <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/requisition/apply">
