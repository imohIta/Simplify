...
#check if user has access to this page ( super admin | POS units )
    $registry->get('authenticator')->checkPrivilege($thisUser->get('activeAcct'), array(1,4,12), true);
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        ?>/stock/addKitchenItem">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control chosen-select" name="item"  required>
                                        <option></option>
                                           <option value="101">Egusi Soup</option>
                                        <option value="102">General Soup</option>
                                        <option value="103">Vegetable Soup</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-4 control-label">Qty to Add</label>
                                <div class="col-sm-4">
