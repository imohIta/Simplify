...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Add Impress Expenditure <small>&nbsp;</small></h1></div>
                   ...
                   <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/impress/addExpenses">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                      <select class="form-control chosen-select form-control-circle"  name="category" required >
                                          <option></option>
                                          <?php foreach (Impress::fetchCategories() as $row) { ?>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                     <input type="text" name="details" class="form-control form-control-circle"  autocomplete="off" required>
