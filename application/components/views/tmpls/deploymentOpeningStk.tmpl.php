...
$registry->get('authenticator')->checkPrivilege($thisUser->get('activeAcct'), array(1,4,8,9,10,11,12,13,14,15), true);
...
?>
    ...
    <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Enter Opening Stock <small>( Deployment )</small></h1></div>
                   ...
                   <?php 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/stock/deploymentOpeningStk">
